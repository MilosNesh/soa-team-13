...
const file_blog_blog_proto_rawDesc = "" +
	"\n" +
	"\x0fblog/blog.proto\x12\x04blog\x1a\x1cgoogle/api/annotations.proto\" \n" +
	...
	"\n" +
	"created_at\x18\x06 \x01(\tR\tcreatedAt2\xb4\x01\n" +
	"\vBlogService\x12N\n" +
	"\aGetBlog\x12\x14.blog.GetBlogRequest\x1a\x15.blog.GetBlogResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/v1/blogs/{id}\x12U\n" +
	"\n" +
	"CreateBlog\x12\x17.blog.CreateBlogRequest\x1a\x18.blog.CreateBlogResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/blogsB\x15Z\x13blog.com/proto/blogb\x06proto3"
